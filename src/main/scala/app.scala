...
object app extends App {
  ...
  val uriArg = args.headOption.getOrElse("https://www.google.com/","https:www.github.com")
  ...
  /**Set the Oracle default trust store password, if https access does not work.*/
